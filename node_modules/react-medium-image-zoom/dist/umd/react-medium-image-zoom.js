(function (global, factory) {
  ...
  exports.isDeepEqual = react;
  });

  unwrapExports(util);
  var util_1 = util.isClient;
  var util_2 = util.on;
  var util_3 = util.off;
  var util_4 = util.isDeepEqual;
  ...
  var defaultTarget = util.isClient ? window : null;
  ...
  ***************************************************************************** */
  ...
  var useWindowSize = function (initialWidth, initialHeight) {
      ...
      var _a = useRafState_1$1.default({
          width: util.isClient ? window.innerWidth : initialWidth,
          height: util.isClient ? window.innerHeight : initialHeight,
