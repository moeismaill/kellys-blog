...
export declare function choose<TContext, TEvent extends EventObject>(conds: ChooseConditon<TContext, TEvent>[]): ChooseAction<TContext, TEvent>;
export declare function resolveActions<TContext, TEvent extends EventObject>(machine: StateNode<TContext, any, TEvent>, currentState: State<TContext, TEvent> | undefined, currentContext: TContext, _event: SCXML.Event<TEvent>, actions: ActionObject<TContext, TEvent>[]): [ActionObject<TContext, TEvent>[], TContext];
